...
function rpc(request, callback) {
  ...
  var errorMessage = 'Dash JSON-RPC: host=' + self.host + ' port=' + self.port + ': ';
...
// TODO remove any bitcoin specific commands
// TODO add dash specific commands, like masternode stuff
RpcClient.callspec = {
  addMultiSigAddress: '',
  addNode: '',
  backupWallet: '',
